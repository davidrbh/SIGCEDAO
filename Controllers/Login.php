<?php 
	...
	class Login extends Controllers{
			...
			if($_POST){
				...
				if(empty($_POST['txtEmailReset'])){
					...
					if(empty($arrData)){
						...
						$dataUsuario = array('nombre_usuario' => $nombre_usuario,
											 'email' => $strEmail,
		...
		{
			if(empty($_POST['id_usuario']) || empty($_POST['txtEmail']) || empty($_POST['txtToken']) || empty($_POST['txtPassword']) ||
				...
				if($strPassword != $strPasswordConfirm){
					$arrResponse = array('status' => false,
						...
						$arrResponse = array('status' => false,
								...
								$requestPass =  $this->model->insertPassword($intId_Usuario, 
																			$strPassword);
							}
							if($requestPass){
								$arrResponse = array('status' => true,
