        ...
        <div class="tile">
            <div class="tile-body">
              <form id="formPerfil" name="formPerfil" class="form-horizontal"> 
                  <p class="text-primary">Los campo con asterisco (<span class="required">*</span>) son obligatorios. </p>

              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="txtCedula">Cédula <span class="required">*</span></label>
                  <input type="text" class="form-control valid validNumber" name="txtCedula" id="txtCedula" value="<?= $_SESSION['userData']['cedula'];?>"  required="">
                </div>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  value="<?= $_SESSION['userData']['email_user'];?>" required="" readonly disnable>
                </div>
              </div>
