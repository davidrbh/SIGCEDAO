        ...
        <div class="col-md-12">
	        ...
	        grid-auto-rows: minmax(70px, auto)">
                    ...
                    <div class='uno' style="grid-row: 1;display:grid; align-items: center">
                        ...
                        <div class="col-md-x">
                            <a href="<?= media(); ?>/archivos/constancia_estudio.pdf" download="constancia_estudio"
                                ...
                                <div class="widget-small primary" style="height: 6rem;" ><i class="icon fa fa-file-invoice"></i>
                                    <div class="info">
                        ...
                        <div class="col-md-x">
                            <a href="<?= media(); ?>/archivos/constancia_inscripcion.pdf"
                                ...
                                <div class="widget-small info" style="height: 6rem;"><i class="icon fa fa fa-id-card-o fa-3x"></i>
                                    <div class="info">
                        ...
                        <div class="col-md-x">
                            <a href="<?= media(); ?>/archivos/acta_compromiso.pdf" download="acta_compromiso type="
                                ...
                                <div class="widget-small danger" style="height: 6rem;"><i class="icon fa fa fa-file-pdf fa-3x"></i>
                                    <div class="info">
                    ...
                    <div class="centrar" >
                        ...
                        <img id="escudo" src="<?= media(); ?>/images/escudo_hd.png" style="">
