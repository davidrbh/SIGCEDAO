...
if(document.querySelector("#formLogin")){
      ...
      formLogin.onsubmit = function(e) { 
            ...
            {
                  swal("Por favor", " Ingrese su usuario y contraseña.", "error");
                  return false; 
...
$(document).ready(function() {
      $('#show-hide-password').on('click', function(e) {
            ...
            if(current == 'hide') {
                  document.getElementById("mostrar").textContent="ocultar contraseña";
                  $(this).prev().attr('type','text');
                  $(this).removeClass('fa-solid fa-eye').addClass('fa-solid fa-eye-slash').attr('action','show');
            }else{

            if(current == 'show') {
                  document.getElementById("mostrar").textContent="mostrar contraseña";
                  $(this).prev().attr('type','password');
                  $(this).removeClass('fa-solid fa-eye-slash').addClass('fa-solid fa-eye').attr('action','hide');
            }}
      })
})
